...
public class JwtObject {
	...
	public String sign_with_AllAlgorithems(ByteSigner jwsSigner, String alg, String kid, boolean canonicalize) throws JOSEException {
		JWSAlgorithm algorithm= new JWSAlgorithm(alg);
		return this.sign(new JWSSignerAdapter(jwsSigner, algorithm), algorithm, kid, canonicalize);
	}

	public String sign_with_AllAlgorithems(ByteSigner jwsSigner, String alg, String kid) throws JOSEException {
		return this.sign_with_AllAlgorithems(jwsSigner, alg, kid, false);
	}
	
	public String sign_with_AllAlgorithems(ByteSigner jwsSigner, String alg) throws JOSEException {
		return this.sign_with_AllAlgorithems(jwsSigner, alg, null, false);
	}
	...
	public String sign_RSA_PS256(com.nimbusds.jose.jwk.RSAKey privateKey, String kid, boolean canonicalize)
	...
	public String sign_RSA_RS256(com.nimbusds.jose.jwk.RSAKey privateKey, String kid, boolean canonicalize)
			throws JOSEException {
	...
	public String sign_Ed25519_EdDSA(com.nimbusds.jose.jwk.OctetKeyPair privateKey, String kid, boolean canonicalize)
			throws JOSEException {
	...
	public String sign_secp256k1_ES256K(com.nimbusds.jose.jwk.ECKey privateKey, String kid, boolean canonicalize)
			throws JOSEException {
	...
	public String sign_P_256_ES256(com.nimbusds.jose.jwk.ECKey privateKey, String kid, boolean canonicalize)
			throws JOSEException {
	...
	public String sign_P_384_ES384(com.nimbusds.jose.jwk.ECKey privateKey, String kid, boolean canonicalize)
			throws JOSEException {
	...
	public String sign_P_521_ES512(com.nimbusds.jose.jwk.ECKey privateKey, String kid, boolean canonicalize)
			throws JOSEException {
