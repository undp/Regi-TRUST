...
class Zone(Base):
    ...
    def contains_name(self, name):
        ...
        logging.debug("Apex domain name in BD: " + self.apex)
        logging.debug("Top domain of apex: " + topDomain)
        logging.debug("Scheme name requested " + name)
        logging.debug("Passes validation? scheme name ends in " + self.apex + "?: " + str(name.endswith(topDomain)))
